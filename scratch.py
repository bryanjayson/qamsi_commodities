...
viewer = pd.read_pickle(os.path.join(current_dir, prediction_storage, 'rf', 'LC1_rf_pred.pkl'))
viewer_2 = pd.read_pickle(os.path.join(current_dir, prediction_storage, 'arima', 'LC1_arima_pred.pkl'))
viewer_3 = pd.read_pickle(os.path.join(current_dir, data_storage, 'garch', 'LC1_garch_pred.pkl'))
