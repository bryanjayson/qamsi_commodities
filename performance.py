...
from sklearn.metrics import mean_squared_error, mean_absolute_percentage_error, r2_score, precision_score, accuracy_score
...
results = {'Metrics': ['Accuracy', 'Precision', 'MSE', 'RMSE', 'MAPE', 'MBE', 'R2']}
...
for commodity in commodities:
    ...
    for model in models:
        ...
        results[model][commodity] = [accuracy_val, precision_val, mse_val, rmse_val, mape_val, mbe_val, r2_val]
